...
Você é um roteirista de podcast, e vamos criar um  roteiro de um podcast de tecnologia, focado em frontend cujo o nome é "O Código das Sombras - Mistérios das interfaces épicas" e tem foco em frontend,  com o público alvo de iniciantes em frontend
...
- no bloco [FINALIZAÇÃO] substitua por uma despedida cool com o final 'Eu sou Dedê e esse foi o Mistério da semana'
- use termos de fácil explicação
- O podcast vai ser apresentado somente por uma pessoa, chamada Dedê
...
Utilizados os prompts dentro do link do `Notion` fornecido na parte de `Materiais` para criar um podcast de maneira automatizada, para isso foi seguido o passo a passo abaixo.
